...
export default {
  ...
  methods: {
    ...
    save(){
      ...
      let checkedKeys = this.$refs.tree.getCheckedKeys();//获取选中节点
      let halfCheckedKeys = this.$refs.tree.getHalfCheckedKeys();//获取半选中节点
      var ids = checkedKeys.concat(halfCheckedKeys).join(",");
